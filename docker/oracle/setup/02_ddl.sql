...
CREATE VIEW DTM_OWNER.CATEGORY AS SELECT * from DTM_OWNER.LOCAL_CATEGORY;

CREATE VIEW DTM_OWNER.SYSTEM AS SELECT * from DTM_OWNER.LOCAL_SYSTEM;

CREATE VIEW DTM_OWNER.REGION AS SELECT * from DTM_OWNER.LOCAL_REGION;

CREATE VIEW DTM_OWNER.COMPONENT AS SELECT * from DTM_OWNER.LOCAL_COMPONENT;

CREATE VIEW DTM_OWNER.WORKGROUP AS SELECT * from DTM_OWNER.LOCAL_WORKGROUP;
