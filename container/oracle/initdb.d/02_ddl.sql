...
CREATE TABLE DTM_OWNER.PROGRAM
(
    PROGRAM_ID       INTEGER NOT NULL,
    EVENT_TYPE_ID    INTEGER NOT NULL,
    NAME             VARCHAR2(128 CHAR) NOT NULL,
    CONSTRAINT PROGRAM_PK PRIMARY KEY (PROGRAM_ID),
    CONSTRAINT PROGRAM_AK1 UNIQUE (EVENT_TYPE_ID, NAME),
    CONSTRAINT PROGRAM_FK1 FOREIGN KEY (EVENT_TYPE_ID) REFERENCES DTM_OWNER.EVENT_TYPE (EVENT_TYPE_ID) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT INCIDENT_FK2 FOREIGN KEY (PROGRAM_ID) REFERENCES DTM_OWNER.PROGRAM (PROGRAM_ID) ON DELETE SET NULL
);
