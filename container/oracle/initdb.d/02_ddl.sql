...
CREATE TABLE DTM_OWNER.HALL_AFFECTED
(
    INCIDENT_ID INTEGER NOT NULL,
    HALL        VARCHAR2(1 CHAR) NOT NULL,
    CONSTRAINT HALL_AFFECTED_PK PRIMARY KEY (INCIDENT_ID, HALL),
    CONSTRAINT HALL_AFFECTED_FK1 FOREIGN KEY (INCIDENT_ID) REFERENCES DTM_OWNER.INCIDENT (INCIDENT_ID) ON DELETE CASCADE,
    CONSTRAINT HALL_AFFECTED_CK1 CHECK (HALL IN ('A','B','C','D'))
);
