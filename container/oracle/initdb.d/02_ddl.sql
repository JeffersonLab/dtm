...
CREATE TABLE DTM_OWNER.SETTINGS
(
    SETTINGS_ID          INTEGER NOT NULL,
    AUTO_EMAIL_YN        CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    LOGBOOK_YN           CHAR(1 CHAR) DEFAULT 'N' NOT NULL,
    BOOKS_CSV            VARCHAR2(128 CHAR) DEFAULT 'TLOG' NOT NULL,
    EXPERT_EMAIL_CC_CSV  VARCHAR2(512 CHAR) NULL,
    CONSTRAINT SETTINGS_PK PRIMARY KEY (SETTINGS_ID),
    CONSTRAINT SETTINGS_CK1 CHECK (AUTO_EMAIL_YN IN ('Y', 'N')),
    CONSTRAINT SETTINGS_CK2 CHECK (LOGBOOK_YN IN ('Y', 'N'))
);
