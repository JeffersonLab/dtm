 ...
 */
@WebServlet(
    name = "IncidentDowntime",
    urlPatterns = {"/reports/incident-downtime"})
public class IncidentDowntime extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (params.getStart() != null && params.getEnd() != null) {
      ...
      DateIterator it =
          new DateIterator(
              TimeUtil.startOfDay(params.getStart(), Calendar.getInstance()),
              TimeUtil.startOfDay(params.getEnd(), Calendar.getInstance()));
    ...
    request
        .getRequestDispatcher("/WEB-INF/views/reports/incident-downtime.jsp")
