 ...
 * @author ryans
 */
@WebServlet(name = "AnnualRepair", urlPatterns = {"/operability/annual-repair"})
public class AnnualRepair extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/operability/annual-repair.jsp").forward(request,
                response);
    }
