 ...
 * @author ryans
 */
@WebServlet(name = "ExcelTuneIncidentList", urlPatterns = {"/excel/tune-incident-list.xlsx"})
public class ExcelTuneIncidentList extends HttpServlet {

    @EJB
    IncidentReportService incidentReportService;
    @EJB
    ExcelIncidentListService excelService;
    @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String filters = FilterSelectionMessage.getReportMessage(start, end, type, null, null, null, component, true, false);
