 ...
 * @author ryans
 */
@WebServlet(name = "EventAudit", urlPatterns = {"/reports/activity-audit/event-audit"})
public class EventAudit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/activity-audit/event-audit.jsp").forward(request, response);
    }
}
