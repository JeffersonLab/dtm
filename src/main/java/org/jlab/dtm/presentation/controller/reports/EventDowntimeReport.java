 ...
 * @author ryans
 */
@WebServlet(name = "EventDowntimeReport", urlPatterns = {"/reports/event-downtime"})
public class EventDowntimeReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (params.getStart() != null && params.getStart() != null && type != null) {
            ...
            downtimeList = downtimeFacade.findByPeriodAndTypeSortByDuration(params.getStart(), params.getEnd(), type, params.getBeamTransport());
        ...
        String selectionMessage = FilterSelectionMessage.getDateRangeReportMessage(params.getStart(), params.getEnd(), type, null, null, null,
                null, params.getBeamTransport(), "Event", params.getData(), false);
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/event-downtime.jsp").forward(request, response);
    }   
}
