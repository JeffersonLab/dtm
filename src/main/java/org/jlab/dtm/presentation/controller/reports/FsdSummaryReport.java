 ...
 * @author ryans
 */
@WebServlet(name = "FsdSummaryReport", urlPatterns = {"/reports/fsd-summary"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (params.getStart() != null && params.getEnd() != null) {
            ...
            try {
                ...
                LOGGER.log(Level.FINEST, "FSD report service call seconds: {0}", (serviceCallEnd
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/fsd-summary.jsp").forward(request,
                response);

        long getEndMillis = System.currentTimeMillis();

        LOGGER.log(Level.FINEST, "FSD report Get method seconds: {0}", (getEndMillis
