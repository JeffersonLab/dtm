 ...
 * @author ryans
 */
@WebServlet(name = "RARReport", urlPatterns = {"/rar"})
public class RARReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        IncidentUrlParamHandler paramHandler
                = new IncidentUrlParamHandler(request, eventTypeFacade, previousMonthStart, previousMonthEnd, IncidentSortKey.TIME_DOWN);
        ...
        request.getRequestDispatcher("/WEB-INF/views/rar.jsp").forward(request, response);
    }
