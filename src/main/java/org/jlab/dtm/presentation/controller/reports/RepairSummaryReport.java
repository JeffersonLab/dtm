 ...
 */
@WebServlet(
    name = "RepairSummaryReport",
    urlPatterns = {"/reports/repair-summary"})
public class RepairSummaryReport extends HttpServlet {

  private static final Logger LOGGER = Logger.getLogger(RepairSummaryReport.class.getName());
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if (params.getStart() != null && params.getEnd() != null) {
      ...
      DateRange range =
          HistogramBin.adjust(params.getStart(), params.getEnd(), params.getBinSize());
      ...
      try {
        ...
        LOGGER.log(
            Level.FINEST,
            "Repair report service call seconds: {0}",
    ...
    request
        .getRequestDispatcher("/WEB-INF/views/reports/repair-summary.jsp")
    ...
    LOGGER.log(
        Level.FINEST,
        "Repair report Get method seconds: {0}",
