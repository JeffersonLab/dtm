 ...
 * @author ryans
 */
@WebServlet(name = "IncidentList", urlPatterns = {"/shiftlog/incident-list.html"})
public class IncidentList extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (eventTypeId == null && request.getParameter("type") == null) { // null is different than empty string
        ...
        String filters = FilterSelectionMessage.getReportMessage(start, end, type, selectedSystem,
                null, null, component, beamTransport, false);
        ...
        request.getRequestDispatcher("/WEB-INF/views/shiftlog/incident-list.jsp").forward(request,
                response);
    }
}
