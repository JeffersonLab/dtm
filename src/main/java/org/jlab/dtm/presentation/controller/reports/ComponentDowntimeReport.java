 ...
 * @author ryans
 */
@WebServlet(name = "ComponentDowntimeReport", urlPatterns = {"/reports/component-downtime"})
public class ComponentDowntimeReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<EventType> eventTypeList = eventTypeFacade.findAll(new AbstractFacade.OrderDirective(
                "weight"));
        List<SystemEntity> systemList = systemFacade.findAll(new OrderDirective("weight"),
                new OrderDirective("name"));
        ...
        if (params.getStart() != null && params.getEnd() != null) {
            ...
            downtimeList = downtimeFacade.findByPeriodAndType(params.getStart(), params.getEnd(),
                    type, params.getBeamTransport(), params.getSystemId());
        ...
        String selectionMessage
                = FilterSelectionMessage.getDateRangeReportMessage(params.getStart(),
                        params.getEnd(), type, selectedSystem, null, null,
                        null, params.getBeamTransport(), "Component", params.getData(), false);
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/component-downtime.jsp").forward(
                request, response);
    }
}
