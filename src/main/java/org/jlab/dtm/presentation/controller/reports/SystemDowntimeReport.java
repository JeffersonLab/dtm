 ...
 * @author ryans
 */
@WebServlet(name = "SystemDowntimeReport", urlPatterns = {"/reports/system-downtime"})
public class SystemDowntimeReport extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (params.getStart() != null && params.getEnd() != null) {
            ...
            periodDurationHours = (params.getEnd().getTime() - params.getStart().getTime()) / 1000.0
                    / 60.0 / 60.0;

            downtimeList = downtimeFacade.findByPeriodAndType(params.getStart(), params.getEnd(),
                    type, params.getBeamTransport(), params.getCategoryId(), false);
            ...
            nonOverlappingSystemDowntimeList = downtimeFacade.findByPeriodAndType(params.getStart(),
                    params.getEnd(), type, params.getBeamTransport(), params.getCategoryId(), true);
            ...
            nonOverlappingCategoryDowntimeList = categoryDowntimeFacade.findByPeriodAndType(
                    params.getStart(), params.getEnd(),
                    type, params.getBeamTransport(), true, params.getCategoryId());
        ...
        String selectionMessage
                = FilterSelectionMessage.getDateRangeReportMessage(params.getStart(),
                        params.getEnd(), type, null, selectedCategory, null,
                        null, params.getBeamTransport(), "System", params.getData(),
                        params.getPacked());
        ...
        request.setAttribute("nonOverlappingCategoryDowntimeHours",
                nonOverlappingCategoryDowntimeHours);
        ...
        request.getRequestDispatcher("/WEB-INF/views/reports/system-downtime.jsp").forward(request,
                response);
    }
}
