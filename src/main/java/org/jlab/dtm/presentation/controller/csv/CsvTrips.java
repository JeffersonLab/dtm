 ...
 * @author ryans
 */
@WebServlet(name = "CsvTrips", urlPatterns = {"/csv/trips.csv"})
public class CsvTrips extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            excelService.exportAsCsv(response.getOutputStream(), filter, selectionMessage, "agg".equals(request.getParameter("format")));
