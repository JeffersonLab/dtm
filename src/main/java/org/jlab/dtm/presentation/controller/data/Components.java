 ...
 * @author ryans
 */
@WebServlet(name = "Components", urlPatterns = {"/data/components"})
public class Components extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            componentList = componentFacade.findMustFilter(categoryIdArray, systemIdArray, q, componentId, max, offset);

            if (max != null) {
                totalRecords = componentFacade.countMustFilter(categoryIdArray, systemIdArray, q, componentId, max);
            } else {
