 ...
 * @author ryans
 */
@WebServlet(name = "TuneIncidents", urlPatterns = {"/beam-team/tune-incidents"})
public class TuneIncidents extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SystemEntity> systemList = systemFacade.findAll(new AbstractFacade.OrderDirective(
                "weight"), new AbstractFacade.OrderDirective("name"));
        ...
        String selectionMessage
                = FilterSelectionMessage.getDateRangeReportMessage(params.getStart(),
                        params.getEnd(), type, null, null, null, params.getComponent(), null, null,
                        "incident", false);

        selectionMessage = selectionMessage + "{" + paginator.getStartNumber() + " - "
        ...
        request.getRequestDispatcher("/WEB-INF/views/beam-team/tune-incidents.jsp").forward(request,
                response);
    }
}
