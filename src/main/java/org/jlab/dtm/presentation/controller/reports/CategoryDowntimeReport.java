 ...
 * @author ryans
 */
@WebServlet(name = "CategoryDowntimeReport", urlPatterns = {"/reports/category-downtime"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (params.getStart() != null && params.getEnd()
            ...
            downtimeList = downtimeFacade.findByPeriodAndType(params.getStart(), params.getEnd(),
                    type, params.getBeamTransport(), false, null);
            ...
            nonOverlappingCategoryDowntimeList = downtimeFacade.findByPeriodAndType(params.getStart(), params.getEnd(),
                    type, params.getBeamTransport(), true, null);
        ...
        String selectionMessage
                = FilterSelectionMessage.getDateRangeReportMessage(params.getStart(),
                        params.getEnd(), type, null, null, null,
                        null, params.getBeamTransport(), "Category", params.getData(), params.getPacked());
        ...
        request.setAttribute("nonOverlappingCategoryDowntimeHours", nonOverlappingCategoryDowntimeHours);
        request.setAttribute("periodDurationHours", periodDurationHours);

        request.getRequestDispatcher(
                "/WEB-INF/views/reports/category-downtime.jsp").forward(request, response);
    }
}
