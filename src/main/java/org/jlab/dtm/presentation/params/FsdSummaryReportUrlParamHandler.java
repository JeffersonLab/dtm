...
public class FsdSummaryReportUrlParamHandler implements
        UrlParamHandler<FsdSummaryReportParams> {

    private final HttpServletRequest request;
    private final Date today;
    private final Date sevenDaysAgo;

    public FsdSummaryReportUrlParamHandler(HttpServletRequest request, Date today,
            Date sevenDaysAgo) {
 ...
 /* Note: We use an array regardless if the parameter is multi-valued because a null array means no page ever set this param before vs empty array or array with null elements means someone set it, but value is empty*/
     ...
     */
    @Override
    public void redirect(HttpServletResponse response, FsdSummaryReportParams params) throws
            IOException {
