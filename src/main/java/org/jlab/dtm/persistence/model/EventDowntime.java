...
public class EventDowntime {
    ...
    public EventDowntime(Number eventId, Number downtimeHours, Number restoreHoursBounded, Number incidentCount, String title, Date timeDown, Date timeUp, Date timeDownBounded, Date timeUpBounded, Number downtimeHoursBounded) {
