...
public class IncidentAudFacade extends AbstractFacade<IncidentAud> {
    ...
    @PermitAll
    public List<IncidentAud> filterList(BigInteger incidentId, BigInteger revisionId, int offset, int max) {
        ...
        List<IncidentAud> incidentList = getEntityManager().createQuery(cq).setFirstResult(offset).setMaxResults(max).getResultList();
