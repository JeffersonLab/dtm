...
public class ApplicationRevisionInfoFacade extends AbstractFacade<ApplicationRevisionInfo> {
    ...
    @PermitAll
    public List<ApplicationRevisionInfo> filterList(Date modifiedStart, Date modifiedEnd, BigInteger eventId, BigInteger incidentId, int offset, int max) {
    ...
    @PermitAll
    public Long countFilterList(Date modifiedStart, Date modifiedEnd, BigInteger eventId, BigInteger incidentId) {
        CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
    ...
    public List<AuditedEntityChange> findEntityChangeList(long revision) {
        Query q = em.createNativeQuery("select 'I', incident_id, revtype from incident_aud where rev = :revision union select 'E', event_id, revtype from event_aud where rev = :revision");
