...
public class ExcelTripsService {
    ...
    @PermitAll
    public void exportJoined(OutputStream out, List<JoinedFsdTrip> tripList, String selectionMessage) throws
            IOException {
        ...
        dateStyle.setDataFormat(
                createHelper.createDataFormat().getFormat("dd-MMM-yyyy HH:mm:ss"));
        ...
        row0.createCell(0).setCellValue(
                ...
                + formatter.format(new Date()) + "]: " + selectionMessage);

        wb.write(out);
    }

    @PermitAll
    public void exportMixed(OutputStream out, List<FsdTrip> tripList, String selectionMessage) throws
            IOException {
        Workbook wb = new XSSFWorkbook();
        Sheet sheet1 = wb.createSheet("FSD Trips");
    ...
    @PermitAll
    public void exportAsCsv(OutputStream out, FsdTripFilter filter, String message, boolean aggregate) throws
            SQLException {
    ...
    @PermitAll
    public void exportSummaryAsCsv(ServletOutputStream out, FsdSummaryReportParams params) throws
            SQLException {
