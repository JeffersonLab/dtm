...
public class CategoryDowntimeFacade extends AbstractFacade<Category> {
    ...
    @PermitAll
    public List<CategoryDowntime> findByPeriodAndType(Date start, Date end, EventType type,
            Boolean beamTransport, boolean packed, BigInteger categoryId) {
