...
<t:beam-team-page title="${title}">  
    <jsp:attribute name="stylesheets">
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/css/weekly-repair.css"/>
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/css/weekly-tune.css"/>
    </jsp:attribute>
    <jsp:attribute name="scripts"> 
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/js/event-list.js"></script>           
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/js/weekly-repair.js"></script>
    </jsp:attribute>        
    <jsp:body>
        <section>
                                ...
                                <tbody class="reload-after-edit">
                                    <c:forEach items="${incidentList}" var="incident">
                                        ...
                                        <tr data-incident-id="${incident.incidentId}" data-event-id="${incident.eventId}" data-event-title="${incident.eventTitle}" data-incident-down="${formattedIncidentDown}" data-incident-up="${formattedIncidentUp}" data-system-id="${incident.systemId}" data-component-name="${fn:escapeXml(incident.componentName)}" data-component-id="${incident.componentId}" data-explanation="${fn:escapeXml(incident.explanation)}" data-repaired-by-id-csv="${incident.repairedByIdCsv}" data-reviewed-by="${fn:escapeXml(incident.reviewedByUsername)}">
                                            ...
                                            <td class="problem-td">
                                                <a class="incident-title-link" href="${pageContext.request.contextPath}/all-events?incidentId=${incident.incidentId}&amp;qualified=" title="${fn:escapeXml(incident.summary)}"><c:out value="${incident.title}"/></a>
