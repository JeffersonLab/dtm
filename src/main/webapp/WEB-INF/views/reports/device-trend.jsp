...
<c:set var="title" value="Faulted FSD Device Trend <EXPERIMENTAL>"/>
<t:reports-page title="${title}">  
    <jsp:attribute name="stylesheets">
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/css/trend-report.css"/>
    </jsp:attribute>
    <jsp:attribute name="scripts">
        <script type="text/javascript" src="${cdnContextPath}/jquery-plugins/flot/0.8.3/jquery.flot.min.js"></script>
        <script type="text/javascript" src="${cdnContextPath}/jquery-plugins/flot/0.8.3/jquery.flot.time.min.js"></script>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/v${initParam.resourceVersionNumber}/js/trend-report.js"></script>
    </jsp:attribute>        
    <jsp:body>
        <section>
                ...
                <c:otherwise>
                    ...
                    <c:if test="${fn:length(trendList) > 0}">
                        <div id="data-table-panel" style="${param.chart eq 'table' ? '' : 'display: none;'}">
                            <table id="bar-chart-data-table" data-start-millis="${dtm:getLocalTime(start)}" data-end-millis="${dtm:getLocalTime(endInclusive)}" data-y-axis-prefix="Faulted FSD Device">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="${param.data eq 'count' ? 'selected-column' : ''} count-data">Number of Device Exceptions</th>
