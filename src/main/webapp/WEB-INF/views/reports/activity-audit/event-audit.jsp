...
<t:reports-page title="${title}">  
    ...
    <jsp:body>
        <section>
            ...
            <h2 id="page-header-title">Activity Audit: Event <c:out value="${param.eventId}"/></h2>
                        ...
                        <tfoot>
                            <tr>
                                <th>Modified By:</th>
                                    ...
                                    <th>
                                        <c:out value="${event.revision.user != null ? s:formatUser(event.revision.user) : event.revision.username}"/>
                                    </th>
                                </c:forEach>
                            </tr>
                            <tr>
